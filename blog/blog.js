...
const articleList = document.querySelector('#blog-list');
...
articles.forEach(book => {
    ...
    blogInfo.innerHTML = `
            ...
            <p><strong>Rating:</strong> <span aria-label="${book.stars.length}">${book.stars}</span></p>
            ` 
